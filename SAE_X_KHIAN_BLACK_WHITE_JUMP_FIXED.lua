...
-- Imported from STEAL AN EGG source; UI replaced by SAE X KHIAN UI.
...
BX.module("features.jump", function(BX)
    ...
    function M.arm()
        ...
        sc:connect(svc.UserInputService.JumpRequest, function()
            ...
            -- The hub may replace the Humanoid after execution, so Roblox's
            -- cached ControlModule reference can be stale. Drive the LIVE
            -- Humanoid directly from JumpRequest.
            hum.Jump = true
...
do
    ...
    -- Keep normal keyboard/touch/gamepad jumping working after the Humanoid swap.
    pcall(function() jump.arm() end)
    ...
    -- BLACK / WHITE ROTATING DESIGN
    local designGradient = Instance.new("UIGradient", main)
    ...
    task.spawn(function()
        while main.Parent do
            designGradient.Rotation = (designGradient.Rotation + 2) % 360
            task.wait()
        end
    end)

    -- VISUAL GRAPHICS
    local graphics = Instance.new("Frame", main)
    graphics.Name = "VisualGraphics"
    graphics.Size = UDim2.fromScale(1,1)
    graphics.BackgroundTransparency = 1
    graphics.BorderSizePixel = 0
    graphics.ZIndex = 0
    for i = 1, 3 do
        local ring = Instance.new("Frame", graphics)
        ring.AnchorPoint = Vector2.new(0.5,0.5)
        ring.Position = UDim2.new(0.5,0,0.5,0)
        ring.Size = UDim2.fromOffset(70 + i*45,70 + i*45)
        ...
        task.spawn(function()
            while ring.Parent do
                ring.Rotation = (ring.Rotation + (i % 2 == 0 and -1 or 1)) % 360
                task.wait()
            end
        end)
    end
    ...
    made.Text = "Made by SAEGRR"
    made.TextColor3 = Color3.fromRGB(0,210,100)
    made.TextSize = 9
    ...
    lockButton.BackgroundColor3 = Color3.fromRGB(12,25,17)
    lockButton.BorderSizePixel = 0
    lockButton.Font = Enum.Font.GothamBold
    lockButton.Text = "LOCK"
    lockButton.TextColor3 = Color3.fromRGB(0,255,120)
    ...
    lockButton.MouseButton1Click:Connect(function()
        ...
        lockButton.TextColor3 = locked and Color3.fromRGB(255,255,255) or Color3.fromRGB(0,255,120)
    end)
    ...
    local function button(text, callback, h)
        ...
        b.BackgroundColor3 = Color3.fromRGB(0,95,45)
        b.BorderSizePixel = 0
    ...
    local function toggle(text, callback)
        ...
        b = button(text .. " [OFF]", function()
            ...
            b.BackgroundColor3 = on and Color3.fromRGB(0,145,65) or Color3.fromRGB(0,95,45)
    ...
    notice.Text = "Ready"
    notice.TextColor3 = Color3.fromRGB(170,220,185)
    notice.TextSize = 9
    ...
    local function selectorPopup(titleText, rows, selected, onChanged)
        ...
        any.BackgroundColor3 = Color3.fromRGB(40,70,50)
        ...
        for _, row in ipairs(rows or {}) do
            ...
            b.BackgroundColor3 = selected[id] and Color3.fromRGB(0,120,55) or Color3.fromRGB(18,24,20)
            b.BorderSizePixel = 0
            b.ZIndex = 52
    ...
    bossStatus.TextColor3 = Color3.fromRGB(170,220,185)
    ...
    fightStatus.TextColor3 = Color3.fromRGB(170,220,185)
    ...
    -- Black / blue design.  This is deliberately separate from the main hub.
    --------------------------------------------------------------------------
    local eggsFeature = BX.require("features.eggs")

    pcall(function()
        local s = gui:FindFirstChildOfClass("UIScale")
        if s then s.Scale = math.min(s.Scale, 0.90) end
    end)

    local second = Instance.new("Frame", gui)
    second.Name = "SAEGRR_AutoStealPanel"
    second.Size = UDim2.fromOffset(205, 345)
    second.Position = UDim2.new(0.5, 145, 0.5, -132)
    second.BackgroundColor3 = Color3.fromRGB(7, 9, 14)
    ...
    secondClose.BackgroundColor3 = Color3.fromRGB(25,25,25)
    ...
    selectedText.BackgroundColor3 = Color3.fromRGB(15,15,15)
    ...
    autoStealButton.BackgroundColor3 = Color3.fromRGB(25,25,25)
    ...
    eggList.Size = UDim2.new(1, -18, 1, -114)
    eggList.Position = UDim2.fromOffset(9, 109)
    eggList.BackgroundColor3 = Color3.fromRGB(255,255,255)
    eggList.BackgroundTransparency = 0.15
    eggList.BorderSizePixel = 0
    eggList.ScrollBarThickness = 3
    eggList.ScrollBarImageColor3 = Color3.fromRGB(45, 150, 255)
    ...
    local function refreshEggView()
        ...
        if #list == 0 then
            ...
            empty.TextColor3 = Color3.fromRGB(35, 100, 180)
            empty.TextSize = 9
            empty.ZIndex = 22
            return
        end
    ...
    secondOpenStroke.Color = Color3.fromRGB(255, 255, 255)
    ...
    menuButton.TextColor3 = Color3.fromRGB(230,255,235)
    ...
    ms.Thickness = 2
    ms.Color = Color3.fromRGB(0,255,120)
    local mg = Instance.new("UIGradient", ms)
    mg.Color = gradient.Color
    task.spawn(function()
        while gui.Parent do
            mg.Rotation = (mg.Rotation + 3) % 360
            RunService.RenderStepped:Wait()
        end
    end)
    local visible = true
